...
const handleLogin = async () => {
    ...
    try {
        ...
        statusMessage.value = `Link sent! Check your email to verify your identity. If you do not receive the link, copy and paste this into your browser: ${response.data.data.link}`;
    } catch (error) {
        isError.value = true;
