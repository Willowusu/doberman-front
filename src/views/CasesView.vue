                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <tr v-for="item in cases" :key="item._id"
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-xs font-bold text-gray-700">{{ item.totalRiskScore
                                                }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                        ...
                        <div v-if="cases.length === 0" class="p-20 text-center">
                            ...
                            <p class="text-sm text-gray-500 text-light">System is clear. All transactions are within
                                safety
                                parameters.</p>
                        </div>
                    </div>
...
import CaseDetailsDrawer from '../components/CaseDetailsDrawer.vue';
